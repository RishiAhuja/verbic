...
class _Translation2State extends State<Translation2> {
  ...
  String _hindiText = 'Type something for results';
  int _random = 0;
            ...
            Container(
              ...
              child: TextFormField(
                onChanged: (val) async{
                  ...
                  var translation2 = await translator.translate(translation.toString(), from: 'hi', to: 'en');


                  if(_controller.text != null){
                    setState(() {
                      _hindiText = translation2.toString();
                      print(_hindiText);
                    });
                  }
                  if (_controller.text == "परिणामों के लिए कुछ लिखें!"){
                    print('some');
                    setState(() {
                      _hindiText = 'Type something for results';
                    });
                  }
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(icon: Icon(Icons.share, color: _blackWhite,), onPressed: () {
                    Share.share("$_hindiText -> ${_controller.text.toString()}", subject: _controller.text.trim().toString());
                  }),
